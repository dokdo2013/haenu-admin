<?
    ...
    */
    ...
    $row = mysqli_num_rows($result);
    $real_str = '<h2>Card Information ('.$row.')</h2><table><div class="table-wrapper">';
    while($data = mysqli_fetch_array($result, MYSQLI_BOTH)){
    ...
    <div class="wrapper">
        ...
        <div class="input">
            <form action="./add.php" method="post">
                <input type="text" name="key" id="key" placeholder="카드이름">
                <input type="text" name="value1" id="value1" placeholder="카드번호">
                <input type="text" name="value2" id="value2" placeholder="유효기간">
                <input type="text" name="value3" id="value3" placeholder="CVC">
