<?
    ...
    */
    ...
    $row = mysqli_num_rows($result);
    $real_str = '<h2>Etc Information ('.$row.')</h2><div class="table-wrapper"><table>';
    while($data = mysqli_fetch_array($result, MYSQLI_BOTH)){
        $real_str = $real_str . '<tr><td>'.$data['key'].'</td><td>'.$data['value'].'</td></tr>';
    }
    $real_str = $real_str . '</table></div><br>';
...
<body>
    <div class="wrapper">
        ...
        <hr>
        <div class="middle">
            <form action="./etc.php" method="get">
        ...
        <div class="input">
            <form action="./add.php" method="post">
                <input type="text" name="key" id="key" placeholder="key값">
                <input type="text" name="value" id="value" placeholder="value값">
                <input type="hidden" name="target" value="etc">
